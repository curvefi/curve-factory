...
def remove_liquidity_one_coin(
    ...
    dy: uint256 = 0
    dy_fee: uint256 = 0
    dy, dy_fee = self._calc_withdraw_one_coin(_burn_amount, i, self._balances())
    assert dy >= _min_received

    self.admin_balances[i] += dy_fee * ADMIN_FEE / FEE_DENOMINATOR
