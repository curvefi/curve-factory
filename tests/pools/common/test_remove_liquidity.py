...
def test_remove_liquidity(alice, swap, plain_coins, min_amount, initial_amounts):
...
def test_remove_partial(alice, swap, plain_coins, initial_amounts, plain_pool_size):
...
def test_event(alice, bob, swap, plain_coins, plain_pool_size):
